const CACHE_NAME='budget-2026-v12-product-lines-forecast';
const ASSETS=['./','./index.html','./app.css','./v9.css','./v9-login.css','./v10-dark.css','./v12-product.css','./app.js','./data.js','./v9.js','./v12-product.js','./manifest.webmanifest'];
